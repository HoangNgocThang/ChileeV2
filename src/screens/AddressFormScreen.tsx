            ...
            <KeyboardAvoidingView
                ...
                <ScrollView showsVerticalScrollIndicator={false}
                    ...
                    <View style={{width: formWidth, height: 70}}>
                        <Text style={styles.label}>Số điện thoại người nhận (khác)</Text>
                    ...
                    <View style={{width: formWidth, height: 70, marginTop:15}}>
                        <Text style={styles.label}>Tên đường, số nhà hoặc tòa nhà</Text>
                        <InputText value={address.address}
                                   ...
                                   placeholder="Tên đường, số nhà hoặc tòa nhà" />
                    </View>
...
const styles = StyleSheet.create({
    ...
    addBtn: { width:formWidth*0.9, alignItems: "center", backgroundColor: config.secondaryColor,
