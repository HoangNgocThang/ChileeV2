...
export default class ProductItem2 extends Component<any, any>{
    ...
    renderPopup = () => {
        ...
        if (ProductItem.label) {
            return <View style={styles.freeShip}>
                <Text style={[styles.textFreeShip, ProductItem.label.style]}>
    ...
    render() {
        ...
        const shareInfo = ProductItem.shareInfo ? ProductItem.shareInfo[0] : null;
        return (
...
const styles = StyleSheet.create({
    itemWrap: {marginHorizontal: 5, marginBottom: 10},
    item: {width: defaultWidth * 0.5 - 20, flex: 1, backgroundColor: "#fff", borderRadius: 10, overflow: "hidden"},
    imageWrapper: {justifyContent: "center", alignItems: "center", flex: 0},
    image: {width: defaultWidth * 0.5 - 20, height: defaultWidth * 0.5 - 20},
